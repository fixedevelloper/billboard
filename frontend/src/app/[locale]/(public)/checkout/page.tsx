    ...
    <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6 px-6 py-10">
      ...
      {step === "billboards" && (
        <div className="flex flex-col gap-4">
          {lines.map((line) => (
            <Card key={line.billboardId} className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => removeLine(line.billboardId)}>
                {t("remove")}
              </Button>
            </Card>
          ))}
        ...
        <div className="flex flex-col gap-4">
          <Card>
            ...
            <ul className="mt-3 flex flex-col gap-2">
              {lines.map((line) => (
                <li key={line.billboardId} className="flex items-center justify-between text-sm">
                  <div>
                    <p className="font-medium text-zinc-900 dark:text-zinc-50">{line.title}</p>
